...
class TestController extends AbstractController
{
    public const USERS_DATA = [
        [
            'id'    => '1',
            'email' => 'vtk241_shyes1@student.ztu.edu.ua',
            'name'  => 'Evgeniy Shpakovich 1'
        ],
        [
            'id'    => '2',
            'email' => 'vtk241_shyes2@student.ztu.edu.ua',
            'name'  => 'Evgeniy Shpakovich 2'
        ],
        [
            'id'    => '3',
            'email' => 'vtk241_shyes3@student.ztu.edu.ua',
            'name'  => 'Evgeniy Shpakovich 3'
        ],
        [
            'id'    => '4',
            'email' => 'vtk241_shyes4@student.ztu.edu.ua',
            'name'  => 'Evgeniy Shpakovich 4'
        ]
    ];
